...
- **Role:** Monitors real-time data, reviews and approves insights, manages communication dissemination.
- **Goals:** Quickly identify threats, make informed decisions, ensure timely and accurate communication.
- **Key Interactions:** Dashboard monitoring, insight detail review, approval/rescind actions, communication preview.
...
3.  **Real-time Monitoring:** The dashboard displays an interactive map with active insights, sensor locations, and real-time data feeds.
4.  **Insight Overview:** A summary panel shows the number of active, pending, and disseminated insights.

### 3.2. Insight Review & Approval Workflow
1.  **New Insight Notification:** A visual and/or auditory notification indicates a new **insight** has been generated by the Insight Generation Engine.
...
-   **Data Overlays:**
    ...
    -   **Active Insight Polygons:** GeoJSON polygons from `system_insights`, color-coded by severity.
...
-   **Community Intelligence Feed:** Real-time feed of incoming community reports, with NLP-derived tags for urgency and category.
-   **Insight Summary:** Count of insights by status (Draft, Pending, Approved, Disseminated).

### 4.4. Insight List (Priority Queue)
